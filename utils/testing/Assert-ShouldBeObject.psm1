function Assert-ShouldBeObject {
    Param (
    ...
    if ($aType -eq 'System.Collections.Hashtable') {
        $Property = @(($a.Keys), ($b.Keys)) | ForEach-Object {$_} | Select-Object -uniq
    } else {
        $Property = @(($a.PSObject.Properties | Select-Object -Expand Name), ($b.PSObject.Properties | Select-Object -Expand Name)) | ForEach-Object {$_} | Select-Object -uniq
