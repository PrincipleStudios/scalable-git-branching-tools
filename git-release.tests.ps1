...
Describe 'git-release' {
    It 'handles standard functionality' {
        ...
        $pushParameterFilter = {($args -join ' ') -eq 'push --atomic origin origin/rc/2022-07-14:main :feature/FOO-123 :feature/XYZ-1-services :rc/2022-07-14 new-commit:_upstream'}
    ...
    It 'handles integration branches recursively' {
        ...
        $pushParameterFilter = {($args -join ' ') -eq 'push --atomic origin origin/rc/2022-07-14:main :feature/FOO-123 :integrate/FOO-125_XYZ-1 :feature/FOO-124_FOO-125 :feature/XYZ-1-services :feature/FOO-124-comment :rc/2022-07-14 new-commit:_upstream'}
        Mock git -ParameterFilter $pushParameterFilter {} -Verifiable
